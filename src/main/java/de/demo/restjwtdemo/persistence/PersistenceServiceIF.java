...
public interface PersistenceServiceIF {
    ...
    boolean updateUserById(final int id, final UserModel toUpdate) throws SQLException, Exception;
    boolean deleteUserById(final int id) throws Exception;
    List<GrantedAuthority> getRolesOfUserByUserId(final int userId) throws SQLException;
}
